...
This file has moved to `/docs/admin-notes/inventory.md` (outside the GitHub
Pages publish path).

GH03 — May 2026: internal admin notes were inadvertently being served
publicly at `https://risingperformance.github.io/Curate/cloudflare-deploy/admin-notes/inventory.md`.
